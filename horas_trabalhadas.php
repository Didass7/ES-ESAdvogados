...
// Obter a lista de casos jurídicos ativos
$query_casos = "SELECT id, titulo FROM casos_juridicos WHERE estado = 'aberto'";
        ...
        <div class="card">
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="data_registro" name="data_registro" class="form-control" required value="<?= date('Y-m-d') ?>">
                </div>
        ...
        <div class="card">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" style="text-align: center;">Nenhum registro de horas encontrado.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
